...
//	Long PRESIDENT_OPERATOR_ROLE_ID = 14L; //商务团队总裁助理
	...
	//日志文件根路径
	public static final String LOG_PATH = "D:/log/dass";
	
	//登陆日志文件名前缀标记
	public static final String LOGIN_LOG_FLAG = "loginLog";

	//充值日志文件名前缀标记
	public static final String RECHARGE_LOG_FLAG = "rechargeLog";
